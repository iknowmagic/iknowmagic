...
<table>
  <tr>
    <td width="120" valign="top">
      <a href="https://qram.study">
        <img src="assets/project-qram-study.png" alt="qram.study project card" width="96" />
      </a>
    </td>
    <td valign="top">
...
## Other machines, currently behaving themselves

<table>
  <tr>
    <td width="33%" valign="top">
      <a href="https://parallaxandponder.online">
        <img src="assets/project-parallax-and-ponder.png" alt="Parallax & Ponder project card" width="120" />
      </a>
      <br />
    ...
    <td width="33%" valign="top">
      <a href="https://court-interpreter-toolkit.cod3naut.com/">
        <img src="assets/project-court-interpreter-toolkit.png" alt="Court Interpreter Toolkit project card" width="120" />
      </a>
      <br />
    ...
    <td width="33%" valign="top">
      <a href="https://cod3naut.com">
        <img src="assets/project-cod3naut.png" alt="cod3naut project card" width="120" />
      </a>
      <br />
...
<table>
  <tr>
    <td width="140" valign="top">
      <img src="assets/portrait-ilan.png" alt="Ilan illustrated portrait card" width="120" />
    </td>
    <td valign="top">
      <ul>
...
`TypeScript` · `React` · `Tailwind` · `Python` · `Node` · `UX architecture` · `automation` · `AI-assisted product building`
